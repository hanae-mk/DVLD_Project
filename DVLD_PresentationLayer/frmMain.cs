...
namespace DVLD_Project
{
    public partial class frmMain: Form
    {
        ...
        private void replacementForLostOrDamagedLicencensToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            frmInternationalLicenseApplicationList frm = new frmInternationalLicenseApplicationList();
            frm.ShowDialog();
        }
