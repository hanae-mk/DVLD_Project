...
namespace DVLD_Project.Applications.Local_Driving_License
{
    public partial class frmLocalDrivingLicenseApplicationsList : Form
    {
        ...
        {
            int LicenseID = clsLocalDrivingLicenseApplication.FindLocalDrivingLicenseApplicationInfoByID((int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value).GetActiveLicenseID();
