...
namespace DVLD_BusinessLayer
{
    public class clsLicense
    {
...

        {
            ...
            this.LicenseClassInfo = clsLicenseClass.FindLicenseByID(this.LicenseClass);
        ...
        {
            return clsLicenseData.UpdateLicense(this.ApplicationID, this.LicenseID, 
        ...
        public bool IsDetainedLicenseReleased(int ReleasedByUserID, ref int ApplicationID)
        {
            ...
            return this.DetainedInfo.IsDetainedLicenseReleased(ReleasedByUserID, Application.ApplicationID);
        }
