...
namespace DVLD_Project.Applications.Release_Detained_License
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblApplicationFees.Text = clsApplicationType.FindApplication((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicense).ApplicationTypeFees.ToString();
